...
public class ControlDeStockFrame extends JFrame {
    ...
    private void configurarCamposDelFormulario(Container container) {
        ...
        comboCategoria.addItem(new Categoria(0, "Por favor elige una categoria"));
    ...
    private void modificar(){
        ...
        Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
                    ...
                    registrosActualizados= this.productoController.modificar(nombre, descripcion, cantidad, id);
                    JOptionPane.showMessageDialog(this,registrosActualizados + "Registro actualizado con exito");
    ...
    private void cargarTabla() {
        ...
        /* en el forEach a ejecutar vamos a hacer un array con los valores de la clave de productos, para asi
        * poder crear un array y poder mostrar los datos en pantalla */
